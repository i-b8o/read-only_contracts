...
INSERT INTO regulation ("name", "abbreviation", "title", "created_at") VALUES ('Имя первой записи', 'Аббревиатура первой записи', 'Заголовок первой записи', current_timestamp);
INSERT INTO chapter ("name", "num", "order_num","r_id") VALUES ('Имя первой записи в главы','I',1,1);
