...
cd ../read-only_writer_service/app
function_get $tag "writer"
cd ../../read-only_reader_service/app
function_get $tag "reader"
cd ../../read-only_master_service/app
function_get $tag "master"
# cd ../../read-only_searcher_service/app
# function_get $tag "searcher"
cd ../../read-only_mobile_service/app
function_get $tag "mobile"
cd ../../read-only_http_server/app
function_get $tag "http"
cd ../../read-only_parser/app
